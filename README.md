...
<p align="center">
  <img src="[![Cover-Image-Copy.png](https://i.postimg.cc/HnX8PtWs/Cover-Image-Copy.png)](https://postimg.cc/T52PKgWZ)" />
</p>
<h1>Story Pitch:</h1>
...
<p>For my data visualization, I used Datawrapper to create two bar charts showing the average wages for creative occupations in LA County and the US respectively. Click the links to see the full image of each visualization.</p>
